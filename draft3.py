...
# Load audio file
AUDIO_FILES = [
    'C:/Users/compu/Documents/GitHub/Music-Production-AILab-Project/Tracks/Alesis-Fusion-Bass-Loop.wav',
    'C:/Users/compu/Documents/GitHub/Music-Production-AILab-Project/Tracks/Alesis-Fusion-Bass-Loop.wav',
    'C:/Users/compu/Documents/GitHub/Music-Production-AILab-Project/Tracks/Alesis-Fusion-Bass-Loop.wav',
    'C:/Users/compu/Documents/GitHub/Music-Production-AILab-Project/Tracks/Alesis-Fusion-Bass-Loop.wav',
    'C:/Users/compu/Documents/GitHub/Music-Production-AILab-Project/Tracks/Alesis-Fusion-Bass-Loop.wav'
...
def switch_track(index):
    ...
    with track_lock:
        if index != current_track_index:
            ...
            loop_position = 0
            print(f"Switched to track {index+1}")
...
def audio_callback(outdata, frames, time, status):
    ...
    board = Pedalboard([
        ...
        Compressor(threshold_db=effects["compressor"], ratio=2),
        Chorus(rate_hz=effects["chorus"], depth=0.5)
    ])
            ...
            with effects_lock: #inside lock to avoid reads and/or other modifications
                if rot_deg<180:
                    if up == [1,0,0,0,0]:
                        ...
                        current_effects["chorus"] = ((rot_norm + 1) / 2) * (100)
